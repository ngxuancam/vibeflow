---
title: Coordination Template
description: Copy-pasteable template for coordinating sub-agents via CoordinationBrief and CoordinationResult.
category: reference
...
**Related:** [Work-Unit Orchestration](./WORK_UNIT_ORCHESTRATION.md) · [Agent Orchestration Policy](./AGENT_ORCHESTRATION_POLICY.md)
[Edit this page on GitHub](https://github.com/magicpro97/vibeflow/edit/main/docs/coordination-template.md)
