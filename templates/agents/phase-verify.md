...
Take all phase artifacts and produce a verification report auditing each deliverable against its acceptance criteria. Independent audit, not self-confirmation.
...
A verification report with sign-off verdict (or blocked list), auditing every artifact against its acceptance criteria.
