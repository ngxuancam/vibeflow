<!-- vibeflow:start -->
# AGENTS.md
## ⚡ VibeFlow v0.9.0 Active — local-first orchestrator for AI coding agents (https://github.com/magicpro97/vibeflow).
Project: vibeflow-docs · Goal: Describe the task in plain language — what should be built or accomplished?
...
Powered by VibeFlow v0.9.0 — https://github.com/magicpro97/vibeflow
<!-- vibeflow:end -->
