...
Take an implementation-ready specification and produce working code that compiles, follows project conventions, and passes existing tests. Translation, not invention.
...
Working source files that compile and pass existing tests, conforming to project conventions.
