...
Take a high-level design and produce an implementation-ready specification with interface signatures, DB schemas, error codes, and method signatures. Close the gap between design and code.
...
An implementation-ready spec: API contracts, DB schemas, error codes, edge cases, call sequences.
